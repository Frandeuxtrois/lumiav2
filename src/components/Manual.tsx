    ...
    <div className="bg-surface rounded-awd shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
      ...
      <div className="overflow-y-auto p-6 space-y-4">
        ...
        <Section icon={<Ban size={16} />} title="Bloquear días — feriados, vacaciones, días que no atendés">
          ...
          <p className="mb-3">Arriba tenés tres atajos que te llenan las fechas solos: <strong className="text-ink">Día</strong>, <strong className="text-ink">Semana</strong> y <strong className="text-ink">Mes</strong>. Después retocás las fechas a mano si no cierra justo.</p>
